...
function createtime1() {
  var grt = new Date("02/09/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 冰封之永寂 %c 你正在访问冰封之永寂の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 冰封之永寂") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('冰封之永寂的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
